...
/* For IronMon need to set this list to include ALL legal species.
This is applied to all 'New' users so is being used to generate a base gamedata file 
...
export const defaultStarterSpecies: Species[] = [
  ...
  Species.NIDORAN_F, Species.NIDORAN_M, Species.CLEFAIRY,
  Species.VULPIX, Species.JIGGLYPUFF, Species.ZUBAT,
  Species.ODDISH, Species.PARAS, Species.VENONAT, Species.DIGLETT,
  Species.MEOWTH, Species.PSYDUCK, Species.MANKEY, Species.GROWLITHE,
  Species.POLIWAG, Species.ABRA, Species.MACHOP, Species.BELLSPROUT,
  Species.TENTACOOL, Species.GEODUDE, Species.PONYTA, Species.SLOWPOKE,
  Species.MAGNEMITE, Species.FARFETCHD, Species.DODUO, Species.SEEL,
  Species.GRIMER, Species.SHELLDER, Species.GASTLY, Species.ONIX,
  Species.DROWZEE, Species.KRABBY, Species.VOLTORB, Species.EXEGGCUTE,
  Species.CUBONE, Species.HITMONCHAN, Species.HITMONLEE, Species.LICKITUNG, 
  Species.KOFFING, Species.RHYHORN, Species.CHANSEY, Species.TANGELA, 
  Species.KANGASKHAN, Species.HORSEA, Species.GOLDEEN, Species.STARYU,
  Species.SCYTHER, Species.MR_MIME, Species.JYNX, Species.ELECTABUZZ,
  Species.MAGMAR, Species.PINSIR, Species.TAUROS, Species.MAGIKARP,
  Species.LAPRAS, Species.DITTO, Species.EEVEE, Species.PORYGON,
  Species.OMANYTE, Species.KABUTO, Species.AERODACTYL, Species.SNORLAX,
  Species.DRATINI, Species.CHIKORITA, Species.CYNDAQUIL, Species.TOTODILE,
  Species.SENTRET, Species.HOOTHOOT, Species.LEDYBA, Species.SPINARAK,
  Species.CHINCHOU, Species.PICHU, Species.CLEFFA, Species.IGGLYBUFF,
  Species.TOGEPI, Species.NATU, Species.MAREEP, Species.MARILL, Species.SUDOWOODO,
  Species.HOPPIP, Species.AIPOM, Species.SUNKERN, Species.YANMA, Species.WOOPER,
  Species.MURKROW, Species.MISDREAVUS, Species.UNOWN, Species.WOBBUFFET,
  Species.GIRAFARIG, Species.PINECO, Species.DUNSPARCE, Species.GLIGAR,
  Species.SNUBBULL, Species.QWILFISH, Species.SHUCKLE, Species.HERACROSS,
  Species.SNEASEL, Species.TEDDIURSA, Species.SLUGMA, Species.SWINUB,
  Species.CORSOLA, Species.REMORAID, Species.DELIBIRD, Species.MANTINE,
  Species.SKARMORY, Species.HOUNDOUR, Species.PHANPY, Species.STANTLER,
  Species.SMEARGLE, Species.TYROGUE, Species.SMOOCHUM, Species.ELEKID,
  Species.MAGBY, Species.MILTANK, Species.LARVITAR, Species.TREECKO,
  Species.TORCHIC, Species.MUDKIP, Species.POOCHYENA, Species.ZIGZAGOON,
  Species.WURMPLE, Species.LOTAD, Species.SEEDOT, Species.TAILLOW,
  Species.WINGULL, Species.RALTS, Species.SURSKIT, Species.SHROOMISH,
  Species.SLAKOTH, Species.NINCADA, Species.WHISMUR, Species.MAKUHITA,
  Species.AZURILL, Species.NOSEPASS, Species.SKITTY, Species.SABLEYE,
  Species.MAWILE, Species.ARON, Species.MEDITITE, Species.ELECTRIKE,
  Species.PLUSLE, Species.MINUN, Species.VOLBEAT, Species.ILLUMISE,
  Species.ROSELIA, Species.GULPIN, Species.CARVANHA, Species.WAILMER,
  Species.NUMEL, Species.TORKOAL, Species.SPOINK, Species.SPINDA,
  Species.TRAPINCH, Species.CACNEA, Species.SWABLU, Species.ZANGOOSE,
  Species.SEVIPER, Species.LUNATONE, Species.SOLROCK, Species.BARBOACH,
  Species.CORPHISH, Species.BALTOY, Species.LILEEP, Species.ANORITH,
  Species.FEEBAS, Species.CASTFORM, Species.KECLEON, Species.SHUPPET,
  Species.DUSKULL, Species.TROPIUS, Species.CHIMECHO, Species.ABSOL,
  Species.WYNAUT, Species.SNORUNT, Species.SPHEAL, Species.CLAMPERL,
  Species.RELICANTH, Species.LUVDISC, Species.BAGON, Species.BELDUM,
  Species.TURTWIG, Species.CHIMCHAR, Species.PIPLUP, Species.STARLY,
  Species.BIDOOF, Species.KRICKETOT, Species.SHINX, Species.BUDEW,
  Species.CRANIDOS, Species.SHIELDON, Species.BURMY, Species.COMBEE,
  Species.PACHIRISU, Species.BUIZEL, Species.CHERUBI, Species.SHELLOS,
  Species.DRIFLOON, Species.BUNEARY, Species.GLAMEOW, Species.CHINGLING,
  Species.STUNKY, Species.BRONZOR, Species.BONSLY, Species.MIME_JR,
  Species.HAPPINY, Species.CHATOT, Species.SPIRITOMB, Species.GIBLE,
  Species.MUNCHLAX, Species.RIOLU, Species.HIPPOPOTAS, Species.SKORUPI,
  Species.CROAGUNK, Species.CARNIVINE, Species.FINNEON, Species.MANTYKE,
  Species.SNOVER, Species.ROTOM, Species.PHIONE, Species.SNIVY,
  Species.TEPIG, Species.OSHAWOTT, Species.PATRAT, Species.LILLIPUP,
  Species.PURRLOIN, Species.PANSAGE, Species.PANSEAR, Species.PANPOUR,
  Species.MUNNA, Species.PIDOVE, Species.BLITZLE, Species.ROGGENROLA,
  Species.WOOBAT, Species.DRILBUR, Species.AUDINO, Species.TIMBURR,
  Species.TYMPOLE, Species.THROH, Species.SAWK, Species.SEWADDLE,
  Species.VENIPEDE, Species.COTTONEE, Species.PETILIL, Species.BASCULIN,
  Species.SANDILE, Species.DARUMAKA, Species.MARACTUS, Species.DWEBBLE,
  Species.SCRAGGY, Species.SIGILYPH, Species.YAMASK, Species.TIRTOUGA,
  Species.ARCHEN, Species.TRUBBISH, Species.ZORUA, Species.MINCCINO,
  Species.GOTHITA, Species.SOLOSIS, Species.DUCKLETT, Species.VANILLITE,
  Species.DEERLING, Species.EMOLGA, Species.KARRABLAST, Species.FOONGUS,
  Species.FRILLISH, Species.ALOMOMOLA, Species.JOLTIK, Species.FERROSEED,
  Species.KLINK, Species.TYNAMO, Species.ELGYEM, Species.LITWICK,
  Species.AXEW, Species.CUBCHOO, Species.CRYOGONAL, Species.SHELMET,
  Species.STUNFISK, Species.MIENFOO, Species.DRUDDIGON, Species.GOLETT,
  Species.PAWNIARD, Species.BOUFFALANT, Species.RUFFLET, Species.VULLABY,
  Species.HEATMOR, Species.DURANT, Species.DEINO, Species.LARVESTA,
  Species.CHESPIN, Species.FENNEKIN, Species.FROAKIE, Species.BUNNELBY,
  Species.FLETCHLING, Species.SCATTERBUG, Species.LITLEO,
  Species.FLABEBE, Species.SKIDDO, Species.PANCHAM, Species.FURFROU,
  Species.ESPURR, Species.HONEDGE, Species.SPRITZEE, Species.SWIRLIX,
  Species.INKAY, Species.BINACLE, Species.SKRELP, Species.CLAUNCHER,
  Species.HELIOPTILE, Species.TYRUNT, Species.AMAURA, Species.HAWLUCHA,
  Species.DEDENNE, Species.CARBINK, Species.GOOMY, Species.KLEFKI,
  Species.PHANTUMP, Species.PUMPKABOO, Species.BERGMITE, Species.BERGMITE, 
  Species.NOIBAT, Species.ROWLET, Species.LITTEN, Species.POPPLIO, 
  Species.PIKIPEK, Species.YUNGOOS, Species.GRUBBIN, Species.CRABRAWLER, 
  Species.CUTIEFLY, Species.ROCKRUFF, Species.WISHIWASHI, Species.MAREANIE,
  Species.MUDBRAY,
  Species.DEWPIDER,
  Species.FOMANTIS,
  Species.MORELULL,
  ...
  Species.PINCURCHIN,
  Species.SNOM,
  Species.STONJOURNER, Species.EISCUE, Species.INDEEDEE,
  Species.MORPEKO,
  Species.CUFANT,
  Species.DRACOZOLT,
  Species.ARCTOZOLT,
