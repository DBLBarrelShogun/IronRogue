...
export class TitlePhase extends Phase {
  ...
  showOptions(): void {
    ...
    {
      label: GameMode.getModeName(GameModes.LUNAMON),
      handler: () => {
        this.initIronmonRun(3);
        return true;
      },
      keepOpen: true
    },
  ...
  initIronmonRun( IronMonLevel: integer = 1, maxPartySize: integer = 3): void {

    switch (IronMonLevel) {
    case 3:
      this.scene.gameMode = getGameMode(GameModes.LUNAMON);
      break;
    case 2:
  ...
  start() {
    ...
    const modifierSelectCallback = (rowCursor: integer, cursor: integer) => {
      ...
      case 1:
        ...
        break;
      default:
        const shopOptions = this.scene.gameMode.isLunamon
